...
from ros_collision_detection.msg import CollisionCheckResult, PerceivedObjects, PerceivedObjectMotion
...
def fused_objects_CPM (data):
    ...
    #FusedObject.perceived_objects=


    perceived_objects=[]
    
    #POM=PerceivedObjectMotion()
    #POM.object_type=ObjectID
    ...
    #perceivedobject.append(POM)

    #print(FusedObject.header)
    print(FusedObject.perceived_objects)
    number_of_obj=data.numberOfPerceivedObjects
    #FusedObject.perceived_objects="x" 
    #FusedObject.perceived_objects.=ObjectID
    #print(FusedObject.perceived_objects)
    for x in PerceivedObject:
        #fused_perceived_obj=PerceivedObjects()
        Perceived_Object_Motion=PerceivedObjectMotion()
        Perceived_Object_Motion.object_type=ObjectID
        Perceived_Object_Motion.object_movement.position.x= pose_x
        Perceived_Object_Motion.object_movement.position.y=pose_y
        Perceived_Object_Motion.object_movement.acceleration=acceleration_x
        Perceived_Object_Motion.object_movement.speed=speed_x
        perceived_objects.append(Perceived_Object_Motion)
        #print(Perceived_Object_Motion.object_type)
        #print(Perceived_Object_Motion.object_movement.position.x)
        #print(Perceived_Object_Motion.object_movement.position.y)
        #print(Perceived_Object_Motion.object_movement.acceleration)
        #print(Perceived_Object_Motion.object_movement.speed)
                
        Perceived_Object_Motion.x_length = "5.0"
        Perceived_Object_Motion.y_length = "2.0"
        
    FusedObject.perceived_objects=perceived_objects
    #FusedObject.PrcvdObjects=PerceivedObject.perceived_object
    #FusedObject.ObjectType=PerceivedObject.object_type
    #FusedObject.ObjectMovement=PerceivedObject.object_movement
    #FusedObject.Header=ObjectMovement.header
    #FusedObject.Id=ObjectMovement.id
    #FusedObject.Position_X=ObjectMovement.position.x
    #FusedObject.Position_Y=ObjectMovement.position.y
...
if __name__ == '__main__':
    ...
    map_publisher = rospy.Publisher('/fused_objects_1', PerceivedObjects, queue_size=1000)
